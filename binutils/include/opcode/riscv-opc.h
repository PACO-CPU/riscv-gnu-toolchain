...
#define MATCH_LUTL 0x2b
#define MASK_LUTL  0xc1f0007f
#define MATCH_LUTS 0x8000002b
#define MASK_LUTS 0xf9ff807f
#define MATCH_LUTE 0x4000002b
#define MASK_LUTE  0xe1f0007f
#define MATCH_LUTE2 0x6000002b
#define MASK_LUTE2  0xe000007f
#define MATCH_LUTW 0xc000002b
#define MASK_LUTW  0xe1f00fff
#define MATCH_LUTW2 0xe000002b
#define MASK_LUTW2  0xe0000fff
#define MATCH_ADD_APPROX 0xb
#define MASK_ADD_APPROX  0x200707f
#define MATCH_SUB_APPROX 0x100b
#define MASK_SUB_APPROX  0x200707f
#define MATCH_MUL_APPROX 0x200b
#define MASK_MUL_APPROX  0x200707f
#define MATCH_FADD_S_APPROX 0x400b
#define MASK_FADD_S_APPROX  0x200707f
#define MATCH_FSUB_S_APPROX 0x500b
#define MASK_FSUB_S_APPROX  0x200707f
#define MATCH_FMUL_S_APPROX 0x600b
#define MASK_FMUL_S_APPROX  0x200707f
#define MATCH_FSQRT_S_APPROX 0x200400b
#define MASK_FSQRT_S_APPROX  0x3f0707f
#define MATCH_FADD_D_APPROX 0x200000b
#define MASK_FADD_D_APPROX  0x200707f
#define MATCH_FSUB_D_APPROX 0x200100b
#define MASK_FSUB_D_APPROX  0x200707f
#define MATCH_FMUL_D_APPROX 0x200200b
#define MASK_FMUL_D_APPROX  0x200707f
#define MATCH_FSQRT_D_APPROX 0x200500b
#define MASK_FSQRT_D_APPROX  0x3f0707f
...
DECLARE_INSN(lutl, MATCH_LUTL, MASK_LUTL)
DECLARE_INSN(luts, MATCH_LUTS, MASK_LUTS)
DECLARE_INSN(lute, MATCH_LUTE, MASK_LUTE)
DECLARE_INSN(lute2, MATCH_LUTE2, MASK_LUTE2)
DECLARE_INSN(lutw, MATCH_LUTW, MASK_LUTW)
DECLARE_INSN(lutw2, MATCH_LUTW2, MASK_LUTW2)
DECLARE_INSN(add_approx, MATCH_ADD_APPROX, MASK_ADD_APPROX)
DECLARE_INSN(sub_approx, MATCH_SUB_APPROX, MASK_SUB_APPROX)
DECLARE_INSN(mul_approx, MATCH_MUL_APPROX, MASK_MUL_APPROX)
DECLARE_INSN(fadd_s_approx, MATCH_FADD_S_APPROX, MASK_FADD_S_APPROX)
DECLARE_INSN(fsub_s_approx, MATCH_FSUB_S_APPROX, MASK_FSUB_S_APPROX)
DECLARE_INSN(fmul_s_approx, MATCH_FMUL_S_APPROX, MASK_FMUL_S_APPROX)
DECLARE_INSN(fsqrt_s_approx, MATCH_FSQRT_S_APPROX, MASK_FSQRT_S_APPROX)
DECLARE_INSN(fadd_d_approx, MATCH_FADD_D_APPROX, MASK_FADD_D_APPROX)
DECLARE_INSN(fsub_d_approx, MATCH_FSUB_D_APPROX, MASK_FSUB_D_APPROX)
DECLARE_INSN(fmul_d_approx, MATCH_FMUL_D_APPROX, MASK_FMUL_D_APPROX)
DECLARE_INSN(fsqrt_d_approx, MATCH_FSQRT_D_APPROX, MASK_FSQRT_D_APPROX)
